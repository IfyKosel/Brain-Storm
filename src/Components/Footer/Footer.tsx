...
import Nigeria from "../assets/Nigerian_flag.svg";

const Footer = () => {
    return (
        <div>
            <div className="bg-[#17374C] pt-2 pb-5 md:py-14 px-[2%] md:px-[5%]">
                <div className="">
                        ...
                        <div className="col-span-3 md:col-span-3 m-0 md:ml-10">
                            <div className="hidden md:block">
                                ...
                                <h2 className="font-semibold">
                                    in USA, canada, australia & UK, we can serve
                                    you
                                </h2>
                            </div>
                            <div className="block md:hidden font-semibold">
                                ...
                                <p className="text-[3vw] min-[371px]:text-xs sm:text-sm mt-4 mb-6">
                                    plot 46, bode thomas street, surulere,
                                    101212 lagos, NG
                                </p>
